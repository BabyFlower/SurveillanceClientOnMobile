 ...
 *
 */
public class TutkVideoStart extends TutkComm{
	...
	public TutkVideoStart(String channel, String streamtype){
	...
	protected void setCommand() throws JSONException {
		...
		comm.put(TutkCommControl.VIDEO_START, vs);
	}
	...
	protected Object parse(JSONObject resp) throws JSONException {
		return resp.getInt(TutkCommControl.VIDEO_START);
	}
}
